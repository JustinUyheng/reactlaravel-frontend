	...
	const categories = [
		{
			...
			label: "Buffet",
			image: assets.budget,
			link: "/france-bistro-buffets",
		},
		{
			id: "store-budgetmeals",
			label: "Budget Meals",
			image: assets.buffets,
			link: "/france-bistro-budget-meals",
		},
		{
			id: "store-budgetsnacks",
			label: "Budget Snacks",
			image: assets.budgetmealss,
			link: "/france-bistro-budget-snacks",
		},
		{
			id: "store-snacks",
			label: "Snacks",
			image: assets.snacks,
			link: "/france-bistro-snacks",
		},
	];
