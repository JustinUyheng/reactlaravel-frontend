...
const mealsData = [
	...
	{
		name: "chicken longganisa hamongado rice toppings",
		price: 50,
		image: assets.food_5,
	},
...
const FranceSnacks = () => {
	...
	const handleAddReserve = (item) => {
		...
		// Calculate total items including the new addition
		const totalItems = getCartItemCount(type);

		toast.success(
			`Successfully added to Reserve! You have ${totalItems} item(s) in your reserve list.`
		);
	};
		...
		<div className="fr-snack-container">
			<div className="fr-snack-breadcrumb-trail">
				<h3 className="fr-snack-breadcrumb-text">
					<span className="fr-snack-bistro-name">France Bistro</span> &gt;
					Snacks
				</h3>
			</div>
			...
			<div className="fr-snack-navigation-bar">
				...
				<div className="fr-snack-action-icons">
					...
					<img
						src={
							assets.clipboard
						} /* Assuming assets.clipboard is your order icon */
						alt="Orders"
						title="Go to Orders"
