...
const AppContent = () => {
	...
	const pathsUsingNavbars = [
		...
		"/faspecc-snacks",
		"/faspecc-budget-buffet",
		"/faspecc-budget-snacks",
		"/faspecc-budget-meals",
		"/user-profile",
		"/vendor-add-items",
		"/vendor-list-items",
		"/vendor-orders",
		"/france-bistro-buffets",
		"/france-bistro-budget-meals",
		"/france-bistro-budget-snacks",
		"/france-bistro-snacks",
		"/faspecc-store-category",
		"/choice-faspecc-budget-snacks",
		"/choice-faspecc-budget-meals",
		"/choice-faspecc-buffet",
		"/choice-faspecc-snacks",
		"/france-bistro-stores",
		"/choice-france-bistro-budget-snacks",
		"/choice-france-bistro-budget-meals",
		"/choice-france-bistro-buffet",
		"/choice-france-bistro-snacks",
		"/vendor/dashboard",
		"/vendor/create-store",
	];

	// Admin paths that should exclusively use AdminNavbar.jsx
	...
	const isAnyAdminPath = location.pathname.startsWith("/admin-");

	// Show Navbars (logged-in user navbar) if it's in its list AND NOT an admin path
	const showLoggedInUserNavbars =
		pathsUsingNavbars.includes(location.pathname) && !isAnyAdminPath;
	...
	const showPublicNavbar =
		!showAdminNavbar && !showLoggedInUserNavbars && !isAnyAdminPath;
