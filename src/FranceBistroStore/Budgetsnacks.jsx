...
const data = {
	30: {
		kakanin: [
			...
			{
				id: "bsnack30-kutsinta1",
				img: assets.food_3,
				name: "Kutsinta",
				price: 5,
			},
			{
				id: "bsnack30-kutsinta2",
				img: assets.food_3,
				name: "Kutsinta",
				price: 5,
			},
	...
	return (
		<div className="snacks-container">
			...
			<div className="tabs-bar">
				...
				<div className="tabs">
					{" "}
					{/* Corresponds to your original .price-tabs */}
					<span
			...
			{["kakanin", "breads", "drinks"].map((category) => (
				<div key={category}>
					<div className="category-title">
						CHOICES OF {category.toUpperCase()}
					</div>
					<div className="snack-grid">
						{" "}
						{/* Corresponds to .item-grid */}
						{currentDataForTab[category].map((item) => (
							<div className="snack-card" key={item.id}>
								{" "}
								{/* Corresponds to .item-card */}
