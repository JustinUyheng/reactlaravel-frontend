...
const options350 = [
	{
		...
		title: "OPTION 1",
		menu: [
			"Buttered Chicken Deluxe",
			"Fish Escabeche Special",
			"Four Seasons Deluxe",
			"Garlic Rice",
			"Premium Drinks",
		],
...
const drinks = [
	...
	{
		id: "drink-soft-drinks",
		name: "Soft Drinks",
		price: 25,
		image: assets.drink_2,
	},
	{
		id: "drink-minute-maid",
		name: "Minute Maid",
		price: 30,
		image: assets.drink_3,
	},
	{
		id: "drink-water-500ml",
		name: "Water 500ml",
		price: 15,
		image: assets.drink_4,
	},
];
					...
					{currentOptions.map((opt) => (
						<div className="option-card" key={opt.id}>
							...
							<div className="option-content">
								{" "}
								{/* Renamed for clarity and to wrap details and icons */}
