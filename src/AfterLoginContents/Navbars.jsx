		...
		<>
			<div className="navbars" id="Homepage">
				<div className="navbar-left">
					...
					<Link to="/" onClick={() => handleNavLinkClick("home")}>
						<img
							src={assets.ustpfoodlogo}
							alt="logo"
							className="ustpfoodlogo"
						/>
					</Link>
				</div>
			...
			<div className={`sidebar ${isSidebarOpen ? "show" : ""}`}>
				...
				<div className="sidebar-content">
					...
					<Link
						to="/about-us"
						onClick={() => handleSidebarLinkClick("about-us")}
					>
					...
					<Link
						to="/contact-us"
						onClick={() => handleSidebarLinkClick("contact-us")}
					>
						<div className="sidebar-item">
					...
					<Link
						to="/feedback"
						onClick={() => handleSidebarLinkClick("feedback")}
					>
						<div className="sidebar-item">
